...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/remote-work-handbook/flexsearch.min.js');loadScript('/remote-work-handbook/en.search-data.min.1d2580ba916528014a582dce2281cd141be0c286a5356ead2bcc0725ddb6f440.js',function(){input.required=false;search();});}
