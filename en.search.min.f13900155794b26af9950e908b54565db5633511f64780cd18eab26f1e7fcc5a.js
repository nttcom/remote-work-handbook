...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/remote-work-handbook/flexsearch.min.js');loadScript('/remote-work-handbook/en.search-data.min.4f20f4c5726cf481ea8c3395d8866dada728670521201cff9b11243e70f7d6ba.js',function(){input.required=false;search();});}
